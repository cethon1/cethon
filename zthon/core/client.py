                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @x_L_q\
                                  \n\n--------بـدء تتبـع سجـل سي ثون CETHON--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع سي ثون CETHON--------"
                        ...
                        link = "[SOURCE CE](https://t.me/x_L_q)"
                        text = (
                            "**✘ تقـريـر خطـأ سي ثون CETHON ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر خطـأ سي ثون CETHON✘**\n\n"
                        link = "[SOURCE CE](https://t.me/x_L_q)"
