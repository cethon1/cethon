...
BaqirWF_cmd = (
    "𓆩 [ՏOᑌᖇᑕᗴ MKTHON - ᑕOᑎᖴIᘜ - اوامـر الـردود / والتـرحيب](t.me/MKTHON) 𓆪\n\n"
...
async def on_snip_list(event):
    ...
    for filt in filters:
        if OUT_STR == "** ❈╎لاتوجـد ردود في هـذه الدردشـه ༗**":
            OUT_STR = "𓆩 ՏOᑌᖇᑕᗴ MKTHON - ᑕOᑎᖴIᘜ ᖴIᒪTᗴᖇՏ 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**  ⪼ قائمـه الـردود في هذه الدردشـه :  **\n"
        OUT_STR += "⪼ {}  𓆰.\n".format(filt.keyword)
    await edit_or_reply(
        event,
        OUT_STR,
...
async def on_all_snip_delete(event):
    ...
    if filters:
        ...
        await edit_or_reply(event, "𓆩 ՏOᑌᖇᑕᗴ MKTHON - ᑕOᑎᖴIᘜ ᖴIᒪTᗴᖇՏ 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ تم حذف جـميع الــردود المضـافـهہ بنجـاح☑️**")
    else:
